...
local msg = {"You're that \"Nothing\" when people ask me what I'm thinking about.",
...
windower.register_event('load','login', function()
    ...
    if player then
        coroutine.schedule(function()
            windower.send_command(string.format('input /echo %s\\, %s', player.name, msg[math.random(1,#msg)]))
        end, 5)
    end
